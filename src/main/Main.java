								...
								if (iDChoice == 1) {
									...
									while (true) {
										...
										if (detailChoice == 1) {
											...
											System.out.println();
											if (strategyService01.updateStrategy(foundStrategy.getStrategyId(), newName,
													newStake)) {
											...
											if (deleteChoice == 1) {
												...
												if (strategyService01.deleteStrategy(foundStrategy.getStrategyId())) {
